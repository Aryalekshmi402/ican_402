...
if($rowcount!=0)
{
	...
	while($row=mysqli_fetch_array($result))
	{
		...
		$id=$row['loginid'];
        echo "<script>alert($dbu_type);</script>";
		...
		if($dbu_name==$em && $dbu_pass==$pp && $dbu_status==1 )
		{
			...
			else if($dbu_type=='ostaff')
			{
				...
				//echo "<script>window.location='staff/index.php'
			}
...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.php"> <img src="img/logo.jpg" WIDTH=120 HEIGHT=90  alt="logo"> </a>
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <!--<a class="dropdown-item" href="register/reg.php">STAFF</a>-->
                                        <a class="dropdown-item" href="register/studreg.php">STUDENT</a>
                                    </div>
                                </li>
                               
                                <li class="d-none d-lg-block">
								
                                    <a class="btn_1" style="cursor: pointer;"  onclick="document.getElementById('id01').style.display='block'" style="width:auto;">LOGIN</a>
                                </li>
  ...
  <form class="modal-content animate" action="index.php" method="post" name="fm" id="fm">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <span class="psw">Forgot <a href="student/pages/forms/forgot.php">password?</a></span>
    </div>
  </form>
</div>
                            </ul>
                ...
                <div class="col-xl-3 col-sm-6 col-md-4">
                    <div class="single-footer-widget footer_2">
                        ...
                        <div class="contact_info">
                            ...
                            <p><span> Email : </span>aryasyama402@gmail.com </p>
                        </div>
                    </div>
                </div>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Design is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">aryasyama402@gmail.com</a>
