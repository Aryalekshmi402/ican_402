<?php 
  ...
  if(isset($_SESSION['lid']))
  {
      ...
      $n = ucwords($row['name']);
      $add = ucwords($row['address']);
      $pin = ucwords($row['pincode']);
      $city = ucwords($row['city']);
      $di = $row['districtid'];
      $sta = $row['stateid'];
      $gen = ucwords($row['gender']);
      $da = strtotime($row['dob']);
      $dob = date('d/m/Y', $da);
      $ph = $row['phone'];
      $ed = ucwords($row['education']);
      $jo = ucwords($row['job']);
      ...
      $sq1 = "Select * from tlb_login where loginid='$l'";
            ...
            <div class="form-panel con">
              ...
              <form class="form-horizontal style-form" id="myform" method="post" action="profile.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <label class="col-sm-3 col-sm-3 control-label"><?php echo $ed; ?></label></div>
                </div>

                <div class="form-group" id="txthide2" style="display:none;">
                  <label class="col-sm-2 col-sm-2 control-label">Education</label>
                  <div class="col-sm-10">
                    <input type="text" name="dedu" class="form-control" value="<?php echo $ed; ?>" >
                  </div> 
                </div>

                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Job</label>
                  <div id="txtshow3"><label class="col-sm-3 col-sm-3 control-label"><?php echo $jo; ?></label></div>
                  <div class="col-sm-10" id="txthide3" style="display:none;">
                    <input type="text" name="djob" value="<?php echo $jo; ?>" class="form-control">
                  </div>
                ...
                if(swlt==1)
                  {
                    swal({  type: 'success',
                            ...
                            function()
                            {
                              window.location="/lawfirm/client/profile.php";
                            });
                   }
                else
                  {
...
<?php
  ...
  if(isset($_POST['submit']))
  {
     ...
     $sqll="UPDATE tlb_client SET phone='$phn', education='$edu', job='$job' where loginid='$lin' ";
