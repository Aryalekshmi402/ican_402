      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/forms/mark.php"><i class="fa fa-circle-o"></i> Add Marks</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <!--<li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i> General Elements</a></li>-->
            <li><a href="pages/forms/leave.php"><i class="fa fa-circle-o"></i> Apply Leave</a></li>
            <li><a href="pages/tables/status.php"><i class="fa fa-circle-o"></i> Leave Status</a></li>
            <!-- <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i> Editors</a></li>-->
          </ul>
        </li>
        <!-- <li class="treeview">
