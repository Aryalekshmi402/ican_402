...
$re=mysqli_query($con,"SELECT * FROM `tlb_staff` WHERE  loginid='$l'");
$row1=mysqli_fetch_array($re);
$sid=$row1['staffid'];


$se="SELECT * FROM `tbl_leave` WHERE staffid='$sid'";
                                                 ...
                                                 ?></td>
                                                  ...
                                                  <?php
                                                    ...
                                                    if ($Status==0) {
                                                        ...
                                                        <td><form action="deleteleave.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $b; ?>"/>
    <input type="submit" value="Delete" class="btn btn-inverse-success" >
  </form>
                                                    ...
                                                    elseif ($Status==1) {
                                                       ...
                                                       <td class="text-center"><span class="label label-success m-t-20">Accept</span>
                                                        </td>
                                                        <td><form action="deletejob.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $app; ?>"/>
    <input type="submit" value="Delete" class="btn btn-inverse-success" disabled="">
  </form>
                                                        ...
                                                        ?>
                                                        <td class="text-center"><span class="label label-danger">Reject</span></td>
