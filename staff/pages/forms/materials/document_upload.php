<?php 
  session_start();
  $con=mysqli_connect("localhost","root","","my_lawyer");
  if(isset($_SESSION['lid']))
  {
      $l=$_SESSION['lid'];
      $sq="Select * from tlb_client where loginid='$l'";
...
<body>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered"><?php echo $n; ?></h5>
          <li class="mt">
            <a href="index.php">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="calendar.html">Change Password</a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="document_upload.php">Upload Documents</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="form-panel con">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Add More Documents </h4>
              <form class="form-horizontal style-form" method="post" id="pswform" action="document_upload.php" enctype="multipart/form-data">

                <div class="form-group">
                    <select class="form-control" name="case" style="width:380px;margin-left:213px;">
                        <option value="-1">Select your case number</option>
                        <?php 
                            $result=mysqli_query($con,"select * from tlb_case where loginid='$l'");
                            while($row=mysqli_fetch_array($result)){
                                $t=$row['caseid'];
                                $c="C100".$t;
                        ?>
                        <option value="<?php echo $row['caseid'];?>"> <?php  echo $c; ?></option>
                        <?php    
                            }
                        ?>
                    </select>
                ...
                <div class="form-group">
                    <div>
                        <table id="employee_table" align="center">
                            <tr id="row1">
                               <td><input type="text" name="docname[]" class="form-control" placeholder="Document Title"></td>
  ...
  <script src="pswvalidate.js"></script>
                ...
                if(swlt==1)
                  {
                    swal({  type: 'success',
                            ...
                            function()
                            {
                              window.location="/lawfirm/client/document_upload.php";
                            });
                   }
                else
                  {
        ...
        if($filename!="")
          {
            if($filename==''){
              ...
              {
                move_uploaded_file($_FILES['file']['tmp_name'][$i],'casedocs/'.$filename);

                 $p= mysqli_query($con,"insert into tlb_documents (caseid,docname,docs)values('$caseid','$docname[$i]','$filename')");
