                  ...
                  Please, answer asap.
                    ...
                    <li id="header_notification_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended notification">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="label label-warning"><i class="fa fa-bell"></i></span> Memory #2 Not
                                    Responding.
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="label label-danger"><i class="fa fa-bolt"></i></span> Disk Space
                                    Reached 85%.
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="label label-success"><i class="fa fa-plus"></i></span> New User
                                    Registered.
                                        ...
                                        <table class="table table-striped table-advance table-hover">
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                /*
                                                    $state=$row['state'];
                                                    $dist=$row['district'];
                                                    $sql="Select state_name from tlb_state where stateid='$state'";
                                                    $query=mysqli_query($con,$sql);
                                                    $res=mysqli_fetch_array($query);
                                                    $sqll="Select district from tlb_district where districtid='$dist'";
                                                    $queryy=mysqli_query($con,$sqll);
                                                    $resu=mysqli_fetch_array($queryy);
                                  $f=$row['proof'];*/
...
<a href="del.php?id=<?php echo $ci; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>-->
