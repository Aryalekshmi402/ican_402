    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Staff Salary</h3>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="" v-model="form.year" class="form-control" id="class">
                                                                        <option>2019</option>
                                                                        <option>2020</option>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="" v-model="form.month" class="form-control" id="class">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="" v-model="form.amount" class="form-control" id="class">

                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <button @click="save_salary" class="btn btn-success">Save</button>
            ...
            new Vue({
                ...
                methods: {
                    ...
                    save_salary(){
                        ...
                        axios.post('/adminn/save_salary.php', {
                            ...this.form
                        })
                            .then(({data}) => {
                                swal({
