  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Staff Details</h3>
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  ...
                  <?php
     						$r=mysqli_query($con,"select * from logintbl where usertype='ostudent' and status='1'");
								$no=1;
						    while($rr=mysqli_fetch_array($r)){
								
							
							$li=$rr['loginid'];
							$se=" select * from `tlb_stud` WHERE loginid='$li'";
...
<a href="delstud.php?id=<?php echo $li;?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
