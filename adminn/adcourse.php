    ...
    <head>
        ...
        <script type="text/javascript">
            function add_row() {
                ...
                $rowno = $rowno + 1;
                $("#employee_table tr:last").after("<tr id='row" + $rowno + "'><td><input type='text' name='name[]' placeholder='New Course'></td><td><input type='button' value='DELETE' onclick=delete_row('row" + $rowno + "')></td></tr>");
            }
    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Course Details</h3>
                ...
                <div class="row mt">
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <h4 class="mb"><i class="fa fa-angle-right"></i><b>Add New courses</b></h4>
                            <form class="form-inline" role="form" action="adcourse.php" method="post">


                                <div id="wrapper">

                                    <div id="form_div" style="margin-top:-50px;">
                                        <br>
                                        <table id="employee_table" align=center>
                                            <tr id="row1">
                                                &nbsp;&nbsp;<td><input type="text" size="135" name="name[]"
                                                                       placeholder="New Course" required></td>
        ...
        function swtalert(swlt) {
            if (swlt == 1) {
                swal({
                    ...
                    function () {
                        window.location = "adcourse.php";
                    });
            } else {
                swal({
                        type: 'error',
                        title: 'Oops!!!',
                        text: 'courses not added'
                    },
                    function () {
                        window.location = "adcourse.php";
                    });
    ...
    if (isset($_POST['submit_row'])) {
        ...
        for ($i = 0; $i < count($sub); $i++) {
            if ($sub[$i] != "") {
                ...
                $p = mysqli_query($con, "insert into tbl_class (classname)values('$sub[$i]')");
