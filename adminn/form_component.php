            ...
            <div class="form-panel">
              ...
              <form class="form-inline" role="form" action="form_component.php" method="post" name="form1" align="center">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="exampleInputEmail2" name="email-input" placeholder="Enter email" style="width:200px;" required>
                </div><br><br>
                
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="form-group">Choose Gender : <label class="sr-only" for="exampleInputEmail2" required>Gender</label>
                  <select name="select" id="select" class="form-control" style="width:200px;" required>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="desig" id="exampleInputEmail2" placeholder="Enter designation" style="width:200px;" required>
                </div><br><br>
                <div class="form-group">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Enter Subject :<label class="sr-only" for="exampleInputEmail2">subject</label>
                  <input type="text" class="form-control" name="sub-input" id="exampleInputEmail2" placeholder="Enter subject" style="width:200px;" required>
                </div><br><br>
                
                <div class="form-group">
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Enter Phone :<label class="sr-only" for="exampleInputEmail2">phone number</label>
                  <input type="text" class="form-control" name="phone" id="exampleInputEmail2" placeholder="phone number" style="width:200px;"  maxlength=10 required>
                </div><br><br>
                      
      <div class="form-group">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; dob as password :<label class="sr-only" for="exampleInputPassword2">Password</label> 
                  <input type="date"  class="form-control" id="exampleInputPassword2"  name="password-input" placeholder="Password" style="width:200px;" required>
                </div><br>
                  <br>
