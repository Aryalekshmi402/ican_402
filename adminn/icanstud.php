  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>iCan Student</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i><b> Student Id generator</b></h4>
              <form class="form-inline" role="form" action="icanstud.php" method="post" align="center">
                <div class="form-group">
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Enter Name : <label class="sr-only" for="exampleInputEmail2">Email address</label>
                  <input type="text" class="form-control" name="text-input"  id="exampleInputEmail2" placeholder="Enter name" style="width:200px;">
                </div><br><br>
                
                <div class="form-group">
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Enter Email :<label class="sr-only" for="exampleInputEmail2">Email address</label>
                  <input type="email" class="form-control" id="exampleInputEmail2" name="email-input" placeholder="Enter email" style="width:200px;">
                </div><br><br>
                
                <div class="form-group">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Choose Gender :<label class="sr-only" for="exampleInputEmail2">Gender</label>
                  <select name="select" id="select" class="form-control" style="width:200px;">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="phone" id="exampleInputEmail2" placeholder="phone number" style="width:200px;">
                </div><br><br>
                      
      <div class="form-group">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dob as password:<label class="sr-only" for="exampleInputPassword2">Password</label> 
                  <input type="date"  class="form-control" id="exampleInputPassword2"  name="password-input" placeholder="Password" style="width:200px;">
                </div><br>
                  <br>
...
<?php
  ...
  if(isset($_POST['submitclk']))
  {
     ...
     else
     {
        ...
        $ps=md5($password);
        $sq="INSERT INTO logintbl (emailid,password,usertype,status) VALUES ('$email','$ps','ostudent','1')";
        ...
        if($qu)
        {
          ...
          $lin=$row['loginid'];
          $sqll="INSERT INTO tlb_stud (`loginid`,`name`,`gender`,`phone`) VALUES ('$lin','$name','$gender','$phone')";
