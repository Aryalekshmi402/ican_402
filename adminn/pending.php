  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i><b>Approve/Reject Requests</b></h3>
        <div class="row mb">
          <!-- page start-->
            ...
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  			...
                  			<?php
     						$r=mysqli_query($con,"select * from logintbl where usertype='student' and status='0'");
								$no=1;
						    while($rr=mysqli_fetch_assoc($r)){
								
							
							$li=$rr['loginid'];
							$se=" select * from `studtbl` WHERE loginid='$li'";
							$re=mysqli_query($con,$se);
// echo "<script> alert('$re')
							
							$row=mysqli_fetch_assoc($re);
							$cl=$row['course'];
							$sel=" select * from `tbl_class` WHERE classid='$cl'";
							$ree=mysqli_query($con,$sel);
...
<td><form action="reject.php" method="POST">
    ...
    <input type="submit" value="reject" style="background-color:red; color:white;" > </form>
 </td>
