            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="form_component.php">iCan staff</a></li>
                            <!-- <li><a href="icanstud.php">iCan students</a></li>-->
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="adcourse.php">Add Course</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li class="active">
                                        <a href="leaveapproval.php">Staff</a>
                                        <a href="leaveapproval1.php">Student</a>
                                    </li>
                                </ul>
                            </li>
