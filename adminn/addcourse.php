    ...
    <head>
        ...
        <script type="text/javascript">
            function add_row() {
                ...
                $rowno = $rowno + 1;
                $("#employee_table tr:last").after("<tr id='row" + $rowno + "'><td><input type='text' name='name[]' placeholder='Enter Subject' ></td><td><input type='button' value='DELETE' onclick=delete_row('row" + $rowno + "')></td></tr>");
            }
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    <p class="centered"><a href="profile.html"><img src="img/adm.png" class="img-circle" width="80"></a>
                    </p>
                ...
                <div class="row mt">
                            ...
                            <form action="addcourse.php" method="post">
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3">
                                        <div class="form-group">
                                            <label class="control-label" for="cars">Choose Syllabus:</label>

                                            <select v-model="form.syllabus" class="form-control" id="cars" name="drop">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="cars"><b>Choose Class:</b></label>
                                            <select v-model="form.class_name" class="form-control" name="Course"
                                                    id="course"
                                                    autocomplete="off" required>
                                                <option value="place" disabled selected>Class</option>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <label class="control-label" for="cars"><b>Choose subject and click
                                                            add:</b></label>
                                                    <select v-model="subject" class="form-control">
                                                        <option v-for="subject in subjects"
                                                                :value="{id:subject.subject_id,name:subject.subject_name}">
                                                            {{subject.subject_name}}
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
                                                    <button @click.prevent="select_subject" class="btn btn-info"
                                                            style="margin-top: 22px">Add
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div style="margin-bottom: 5px;" v-for="subject in form.subjects"
                                                 class="form-control">
                                                {{subject.name}}
                                                <span style="cursor: pointer;font-weight: bold" class="pull-right"
                                                      @click="deselect_subject(subject.id)">X</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <button @click.prevent="save_subject" class="btn btn-success">Submit
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <script>
                        new Vue({
                            ...
                            methods: {
                                save_subject() {
                                    if(this.form.subjects.length>0 && this.form.syllabus!=='' && this.form.class_name!==''){
                                        axios.post('/adminn/process_add_course.php', {
                                            data: {...this.form}
                                        })
                                            .then(({data}) => {
                                                swal({
                                ...
                                get_subjects() {
                                    axios.get('/adminn/get_subjects.php', {
                                        params: {
                                            type: 'CLASSES'
                                        }
                                    })
                                ...
                                select_subject() {
                                    let status = true;
                                    this.form.subjects.forEach(el => {
                                        if (el.id === this.subject.id) {
                                            status = false;
                                        }
                                    });
                                    if (status) {
                                        this.form.subjects.push(this.subject);
                                    }

                                },
                                deselect_subject(id) {
                                    this.form.subjects.forEach((el, index) => {
