                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="../staff/dist/img/user2-160x160.jpg" class="img-circle"
                                                         alt="User Image">
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="../staff/dist/img/user3-128x128.jpg" class="img-circle"
                                                         alt="User Image">
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="../staff/dist/img/user4-128x128.jpg" class="img-circle"
                                                         alt="User Image">
                                                </div>
                                                <h4>
                                                    Developers
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <table class="table table-striped table-hover table-striped text-center text-capitalize">
                                               <thead>
                        <tr>
                            <th>sl no:</th>
