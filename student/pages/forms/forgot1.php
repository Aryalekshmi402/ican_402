    ...
    <section class="content">
        ...
        <div class="box box-default" style="height:550px;">
            <div class="box-header with-border" >
                <h3 class="box-title"><b>Forgot your password???</b></h3>
            ...
            <div class="box-body" >
                <div class="row">
                    <div class="col-md-6"><br><br><br><br>
                        <img src="think.jpg" height="400px;">

                    </div>
                    <form action="forgot.php" method="post">
                        <div class="col-md-6" style="margin-left:500px; margin-top:-480px;">
                            <div class="form-group"><br><br><br><br>
                                <label>Enter Your Registered Mail id:</label>
                                <input type="email" name="emailid" placeholder="email" class="form-control text" style="width: 100%;" required>
                        ...
                        <div class="col-md-6" id="x1" style="margin-left:500px; display:none; margin-top:-180px;">

                            <div class="form-group">

                            </div>
                        </div>
                        <div style="margin-left:780px; margin-top:230px;">

                            <input type="submit" value="RECOVER" name="recover" style="background-color:#06F; margin-left:-20px; margin-top:-4px; color:#FF0; width:150px; height:40px;" >
...
<a href="localhost/ican/student/pages/forms/forgot1.php">https://ican/forgot/password</a>
'
        ;//body
