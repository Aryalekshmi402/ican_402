...
<script type='text/Javascript'>
  ...
  <title>ican | General Form Elements</title>
...
<!--              <h4>With icons</h4>
      ...
      <!--    </div>
       ...
       <br><br><br><br><br>
        <div class="col-md-6" >
          <!-- Horizontal Form -->
       <div class="box box-info" style="width:500px; margin-left:200px; margin-top:20px; height:340px;" align="center" >
            <div class="box-header with-border" style="color:#F00">
              <h3 class="box-title"><b><i>Change Your Password..</i></b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
...
<td><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submitclk" value="Change Password" style="background-color:green; color:white;"></td>
<br>
</tr>
 </table>
</form>
...
?>
<?php
  $sq="Select * from logintbl where loginid='$l'";
