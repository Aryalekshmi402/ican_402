    ...
    <section class="content">
      ...
      <div class="box box-default" style="height:550px;">
        <div class="box-header with-border" >
          <h3 class="box-title"><b>Choose Your Subjects</b></h3>
          ...
          <div class="row">
            ...
            <div class="col-md-6" style="margin-left:500px; margin-top:-350px;">
              <div class="form-group"><br><br><br><br>
                ...
                <select class="form-control select2" name="syllabus" style="width: 100%;" onChange="sel(this.value,<?php echo $lid; ?>)">
            ...
            <div class="col-md-6" id="x1" style="margin-left:500px; display:none; margin-top:-180px;">
             ...
             <div style="margin-left:780px; margin-top:400px;">
           
           <input type="submit" value="submit" name="sub" style="background-color:#06F; color:#FF0; width:150px;" >
           <input type="hidden" value="<?php echo $lid; ?>" name="f" />
