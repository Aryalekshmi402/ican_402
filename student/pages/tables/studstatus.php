                                                 ...
                                                 ?></td>
                                                  ...
                                                  <?php
                                                    ...
                                                    if ($Status==0) {
                                                        ...
                                                        <td><form action="delleave.php" method="POST">
    ...
    <input type="submit" value="Delete" class="btn btn-inverse-success" >
                                                    ...
                                                    elseif ($Status==1) {
                                                       ...
                                                       <td class="text-center"><span class="label label-success m-t-20">Accept</span>
                                                        ...
                                                        <td><form action="deljob.php" method="POST">
...
<!-- DataTables -->
<script src="../../../staff/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
